...
\begin{enumerate}
    ...
    See \cite{leitsch} Section 2.2 for a description.
...
\begin{enumerate}
    ...
    \item The output of Struct\textsubscript{{$\forall$}} transformation is a set of formulas. There are at most as many formulas as there are 
